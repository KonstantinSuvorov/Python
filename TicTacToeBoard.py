...
#                 который возвращает X, если победил первый игрок, 
#                 0, если второй, D, если ничья и 
#                 None, если можно продолжать игру;
# make_move(row, col) – который устанавливает значение текущего
#                 хода в ячейку поля с координатами row, col, если это возможно,
#                 «переключает» ход игрока, а также возвращает сообщение:
...
#                - и «Игра уже завершена»,
#                    если в текущей игре уже выявлен победитель
